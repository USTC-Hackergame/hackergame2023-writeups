本人来自AHU，也是第一次参加Hackergame和CTF比赛，不得不说相较于ACM，这种类型的比赛更让我着迷。可惜成绩不如诸位大佬（`分数：2600， 总排名：278 / 2386`）主要原因大抵是眼界不宽广、思维不发散、技术储备不如大佬们罢！（
...
这是本人第一次参加CTF比赛，通过此次锻炼我也发现了自身存在的诸多不足，目前只能仰视诸位大佬，希望自己再接再厉！同时再次感谢USTC Hackergame 2023 全体幕后成员。
